...
namespace KScript.Utils
{
    public class KeyboardHook
    {
        ...
        public void SetHook()
        {
            ...
            var mh1 = GetModuleHandle(cModule.ModuleName);
            //var mh = Marshal.GetHINSTANCE(Assembly.GetEntryAssembly().GetModule(cModule.ModuleName));
            hHook = SetWindowsHookEx(WH_KEYBOARD_LL, KeyboardHookDelegate, mh1, 0);
        }
